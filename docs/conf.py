...
author = "Litestar-Org"
release = os.getenv("_LITESTAR-HTMX_DOCS_BUILD_VERSION", version.rsplit(".")[0])
...
html_theme_options = {
    ...
    # },
    "github_repo_name": "Litestar HTMX",
    "github_url": "https://github.com/litestar-org/litestar-htmx",
    # "pygment_light_style": "xcode",
    # "pygment_dark_style": "lightbulb",
    # "nav_links": [
    #     {"title": "Home", "url": "https://cofin.github.io/litestar-htmx/"},
    #     {"title": "Docs", "url": "https://cofin.github.io/litestar-htmx/latest/"},
    #     {"title": "Code", "url": "https://github.com/cofin/litestar-htmx"},
    # ],
    # "light_css_variables": {
    #     # RGB
