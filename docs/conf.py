...
from litestar_htmx.__metadata__ import __project__, __version__
...
release = os.getenv("_LITESTAR_HTMX_DOCS_BUILD_VERSION", __version__.rsplit(".")[0])
...
html_theme_options = {
    "logo_target": "/",
    "github_repo_name": "litestar-htmxhtmx",
        ...
        },
        {
            ...
            "children": [
                ...
                },
                {
                    ...
                    "url": "https://github.com/litestar-org/litestar-htmx/discussions",
                    "icon": "coc",
                },
                {
